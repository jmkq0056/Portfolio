...
(function () {
  ...
  const DA = {
    ...
    k_work: 'Flagskib · gathrsolutions.dk',
    g1_h: 'Problemet',
    ...
    g2_h: 'Planlægning',
    g2_p: 'Gathr erstatter bunken. Vagtplanlægning med træk og slip oven på en medarbejderdatabase, der kender certificeringer og rådighed.',
    g3_h: 'Ude i marken',
    ...
    g4_h: 'Drift',
    g4_p: 'Jeg har designet den, bygget den og driver den: datamodel, API\'er, web, mobil med offline understøttelse, auth, CI/CD, hosting. Live på App Store og Google Play.',
    ...
    c4_role: 'Styring af indhold på skærme',
    c4_p: 'Et system til at styre indhold på fysiske skærme: hvad der vises på hvilken skærm, opdateret centralt i stedet for med USB stik og en stige. Bygget til rigtig kommerciel brug.',
    c5_h: 'Mobilapps',
    ...
    yr_ongoing: 'Løbende', yr_ongoing2: 'Løbende', now: 'nu',
