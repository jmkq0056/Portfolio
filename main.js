...
(function () {
  ...
  const DA = {
    ...
    lede: 'Grundlægger af <strong>Gathr Solutions</strong>, en startup der bygger en driftsplatform til danske vagtfirmaer. Ude på App Store og Google Play. Jeg tager produkter fra første commit til produktion og holder dem kørende.',
    meta_loc: 'Greve, Storkøbenhavn',
    claim: 'Jeg bygger software, som rigtige virksomheder faktisk kører på. I dag en restaurant. Snart danske vagtfirmaer.',
    n1: 'App udgivelser, iOS og Android, bygget alene',
    n2: 'Vægtet gennemsnit på bacheloren, Aalborg Universitet',
    n3: 'Bachelorprojekt, topkarakter på 7-trinsskalaen',
    ...
    g2_h: 'Planlægning',
    g2_p: 'Gathr er bygget til at erstatte bunken. Vagtplanlægning med træk og slip oven på en medarbejderdatabase, der holder styr på certificeringer og rådighed.',
    g3_h: 'Ude i marken',
    g3_p: 'Runderinger verificeres ved checkpoints med NFC, QR, BLE og GPS, og der går en alarm i samme øjeblik, der sker noget. Oven i det: tidsregistrering, rapportering og en kundeportal.',
    g4_h: 'Drift',
    g4_p: 'Jeg har designet den, bygget den og driver den: datamodel, API\'er, web, mobil med offline-understøttelse, auth, CI/CD og hosting. Ude på App Store og Google Play. En startup i tidlig fase med reel interesse fra danske vagtfirmaer.',
    ...
    c2_p: 'Socialt bevidst bipartit matching med non-interference som privatlivsgaranti, bygget til begivenhedsbaseret samkørsel. En matchingalgoritme, der parrer passagerer uden at afsløre, hvem de er, eller hvor de skal hen.',
    ...
    j2_p: 'Udviklede restaurantens online bestillingsplatform og står for deres IT-drift: bestillingssiden, betalinger, hosting og de systemer, forretningen er afhængig af i hverdagen.',
    ...
    s5_1: 'Systemdesign', s5_2: 'Objektorienteret design', s5_3: 'Compilere', s5_4: 'Agilt samarbejde',
    ...
    contact_p: 'Full stack, mobil, backend og CI/CD. Hvis det ender hos rigtige brugere, er det interessant for mig. København eller remote, og den hurtigste vej til mig er en mail.',
